...
- [x] Commit the completed plan/docs, create a recovery ref, submit the sixth
...
- [x] Close each Kata child and `h381` with commit/test evidence.

- [x] Resume RoboRev reminders on the sixth branch and any lower branch snoozed
